...
// select featured courses in network .... 
$selectedNetwork = $conn->query('select courses.id as id , image ,  name_of_course ,  admins.username as username , price from courses join admins on owner_id = admins.id where category = "network" order by rating desc');
$selectedNetwork->execute();
$network_courses  = $selectedNetwork->fetchAll(PDO::FETCH_ASSOC);
...
<body>
        ...
        <div class="overlay">
            <div class="home-content">
                ...
                <?php if (isset($_SESSION['username'])) : ?>
                    <a class="btn btn-start hover-opacity" href="categoryPage.php">get started !</a>
                <?php else : ?>
    ...
    <?php if ($selectedNetwork->rowCount() > 0) : ?>
        <div class="about pd-y">
            <div class="section-header">
